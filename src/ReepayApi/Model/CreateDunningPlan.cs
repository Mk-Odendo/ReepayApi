...
namespace ReepayApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateDunningPlan :  IEquatable<CreateDunningPlan>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDunningPlan" /> class.
        /// </summary>
        [JsonConstructor]
        protected CreateDunningPlan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDunningPlan" /> class.
        /// </summary>
        ...
        public CreateDunningPlan(string Name = null, List<int?> Schedule = null, string Handle = null, bool? DefaultPlan = null)
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for CreateDunningPlan and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Schedule == null)
            {
                throw new InvalidDataException("Schedule is a required property for CreateDunningPlan and cannot be null");
            }
            else
            {
            ...
            if (Handle == null)
            {
                throw new InvalidDataException("Handle is a required property for CreateDunningPlan and cannot be null");
            }
            else
            {
                this.Handle = Handle;
            ...
            if (DefaultPlan == null)
            {
                throw new InvalidDataException("DefaultPlan is a required property for CreateDunningPlan and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateDunningPlan {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateDunningPlan);
        }

        /// <summary>
        /// Returns true if CreateDunningPlan instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateDunningPlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDunningPlan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
