...
namespace ReepayApi.Model
{
    ...
    public partial class UpdateUserPassword :  IEquatable<UpdateUserPassword>
    {
        ...
        public UpdateUserPassword(string Password = null)
        {
            // to ensure "Password" is required (not null)
            if (Password == null)
            {
                throw new InvalidDataException("Password is a required property for UpdateUserPassword and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateUserPassword);
        }
