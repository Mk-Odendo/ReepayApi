...
namespace ReepayApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SubscriptionSearch :  IEquatable<SubscriptionSearch>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionSearch" /> class.
        /// </summary>
        [JsonConstructor]
        protected SubscriptionSearch() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionSearch" /> class.
        /// </summary>
        ...
        /// <param name="Content">List of subscriptions for current page (required).</param>
        ...
        public SubscriptionSearch(int? Page = null, int? Size = null, int? Count = null, string Search = null, string Sort = null, List<Subscription> Content = null, long? TotalElements = null, int? TotalPages = null)
        {
            // to ensure "Page" is required (not null)
            if (Page == null)
            {
                throw new InvalidDataException("Page is a required property for SubscriptionSearch and cannot be null");
            }
            else
            {
                this.Page = Page;
            ...
            if (Size == null)
            {
                throw new InvalidDataException("Size is a required property for SubscriptionSearch and cannot be null");
            }
            else
            {
                this.Size = Size;
            ...
            if (Count == null)
            {
                throw new InvalidDataException("Count is a required property for SubscriptionSearch and cannot be null");
            }
            else
            {
                this.Count = Count;
            ...
            if (Content == null)
            {
                throw new InvalidDataException("Content is a required property for SubscriptionSearch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TotalElements is a required property for SubscriptionSearch and cannot be null");
            }
            else
            {
            ...
            if (TotalPages == null)
            {
                throw new InvalidDataException("TotalPages is a required property for SubscriptionSearch and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>List of subscriptions for current page</value>
        [DataMember(Name="content", EmitDefaultValue=false)]
        public List<Subscription> Content { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SubscriptionSearch);
        }

        /// <summary>
        /// Returns true if SubscriptionSearch instances are equal
        /// </summary>
        /// <param name="other">Instance of SubscriptionSearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SubscriptionSearch other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
