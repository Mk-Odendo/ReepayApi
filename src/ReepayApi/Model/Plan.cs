...
namespace ReepayApi.Model
{
    ...
    public partial class Plan :  IEquatable<Plan>
    {
        ...
        /// </summary>
        /// <value>State of the subscription plan one of the following: `active`, `superseded`, `deleted`</value>
        ...
        public Plan(string Name = null, string Description = null, float? Vat = null, int? Quantity = null, bool? Prepaid = null, string DunningPlan = null, int? RenewalReminderEmailDays = null, int? TrialReminderEmailDays = null, PartialPeriodHandlingEnum? PartialPeriodHandling = null, bool? AmountInclVat = null, int? FixedCount = null, FixedLifeTimeUnitEnum? FixedLifeTimeUnit = null, int? FixedLifeTimeLength = null, TrialIntervalUnitEnum? TrialIntervalUnit = null, int? TrialIntervalLength = null, int? IntervalLength = null, ScheduleTypeEnum? ScheduleType = null, int? ScheduleFixedDay = null, int? BaseMonth = null, int? NoticePeriods = null, bool? NoticePeriodsAfterCurrent = null, int? FixationPeriods = null, bool? FixationPeriodsFull = null)
        {
            ...
            if (Prepaid == null)
            {
                throw new InvalidDataException("Prepaid is a required property for Plan and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IntervalLength is a required property for Plan and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ScheduleType is a required property for Plan and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Currency for the subscription plan in [ISO 4217](http://da.wikipedia.org/wiki/ISO_4217) three letter alpha code</value>
        [DataMember(Name="currency", EmitDefaultValue=false)]
        public string Currency { get; private set; }
        /// <summary>
        /// Date when the subscripton plan was created. In ISO-8601 extended offset date-time format.
        /// </summary>
        /// <value>Date when the subscripton plan was created. In ISO-8601 extended offset date-time format.</value>
