...
namespace ReepayApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateAccount :  IEquatable<UpdateAccount>
    {
        /// <summary>
        ...
        /// Initializes a new instance of the <see cref="UpdateAccount" /> class.
        /// </summary>
        /// <param name="Handle">Per organisation unique handle for the account (required).</param>
        /// <param name="Currency">Currency for the account in [ISO 4217](http://da.wikipedia.org/wiki/ISO_4217) three letter alpha code.</param>
        ...
        public UpdateAccount(string Handle = null, string Currency = null, string Name = null, string Address = null, string Address2 = null, string City = null, string Locale = null, string Timezone = null, string Country = null, string Email = null, string Phone = null, string Vat = null, string Website = null, string Logo = null, string PostalCode = null, float? DefaultVat = null)
        {
            // to ensure "Handle" is required (not null)
            if (Handle == null)
            {
                throw new InvalidDataException("Handle is a required property for UpdateAccount and cannot be null");
            }
            else
            {
                this.Handle = Handle;
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for UpdateAccount and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Locale == null)
            {
                throw new InvalidDataException("Locale is a required property for UpdateAccount and cannot be null");
            }
            else
            {
                this.Locale = Locale;
            ...
            if (Timezone == null)
            {
                throw new InvalidDataException("Timezone is a required property for UpdateAccount and cannot be null");
            }
            else
            {
            ...
            if (Country == null)
            {
                throw new InvalidDataException("Country is a required property for UpdateAccount and cannot be null");
            }
            else
            {
            ...
            if (DefaultVat == null)
            {
                throw new InvalidDataException("DefaultVat is a required property for UpdateAccount and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateAccount);
        }

        /// <summary>
        /// Returns true if UpdateAccount instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAccount other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
