...
namespace ReepayApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateCardGatewayAgreement :  IEquatable<CreateCardGatewayAgreement>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCardGatewayAgreement" /> class.
        /// </summary>
        [JsonConstructor]
        protected CreateCardGatewayAgreement() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateCardGatewayAgreement" /> class.
        /// </summary>
        ...
        public CreateCardGatewayAgreement(string Provider = null, List<string> CardTypes = null, Dictionary<string, Object> ProviderSettings = null)
        {
            // to ensure "Provider" is required (not null)
            if (Provider == null)
            {
                throw new InvalidDataException("Provider is a required property for CreateCardGatewayAgreement and cannot be null");
            }
            else
            {
            ...
            if (CardTypes == null)
            {
                throw new InvalidDataException("CardTypes is a required property for CreateCardGatewayAgreement and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateCardGatewayAgreement {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateCardGatewayAgreement);
        }

        /// <summary>
        /// Returns true if CreateCardGatewayAgreement instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateCardGatewayAgreement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCardGatewayAgreement other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
