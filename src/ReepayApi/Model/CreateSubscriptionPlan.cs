...
namespace ReepayApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateSubscriptionPlan :  IEquatable<CreateSubscriptionPlan>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionPlan" /> class.
        /// </summary>
        [JsonConstructor]
        protected CreateSubscriptionPlan() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSubscriptionPlan" /> class.
        /// </summary>
        ...
        public CreateSubscriptionPlan(string Name = null, string Description = null, float? Vat = null, int? Quantity = null, bool? Prepaid = null, string DunningPlan = null, int? RenewalReminderEmailDays = null, int? TrialReminderEmailDays = null, PartialPeriodHandlingEnum? PartialPeriodHandling = null, bool? AmountInclVat = null, int? FixedCount = null, FixedLifeTimeUnitEnum? FixedLifeTimeUnit = null, int? FixedLifeTimeLength = null, TrialIntervalUnitEnum? TrialIntervalUnit = null, int? TrialIntervalLength = null, int? IntervalLength = null, ScheduleTypeEnum? ScheduleType = null, int? ScheduleFixedDay = null, int? BaseMonth = null, int? NoticePeriods = null, bool? NoticePeriodsAfterCurrent = null, int? FixationPeriods = null, bool? FixationPeriodsFull = null)
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for CreateSubscriptionPlan and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (Prepaid == null)
            {
                throw new InvalidDataException("Prepaid is a required property for CreateSubscriptionPlan and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("IntervalLength is a required property for CreateSubscriptionPlan and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ScheduleType is a required property for CreateSubscriptionPlan and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Per account unique handle for the subscription plan. Max length 255 with allowable characters [a-zA-Z0-9_.-@].</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateSubscriptionPlan {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateSubscriptionPlan);
        }

        /// <summary>
        /// Returns true if CreateSubscriptionPlan instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateSubscriptionPlan to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateSubscriptionPlan other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
