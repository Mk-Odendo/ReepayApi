...
namespace ReepayApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateWebhookSettings :  IEquatable<UpdateWebhookSettings>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWebhookSettings" /> class.
        /// </summary>
        [JsonConstructor]
        protected UpdateWebhookSettings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateWebhookSettings" /> class.
        /// </summary>
        ...
        public UpdateWebhookSettings(List<string> Urls = null, List<string> AlertEmails = null, int? AlertCount = null)
        {
            // to ensure "Urls" is required (not null)
            if (Urls == null)
            {
                throw new InvalidDataException("Urls is a required property for UpdateWebhookSettings and cannot be null");
            }
            else
            {
                this.Urls = Urls;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateWebhookSettings {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UpdateWebhookSettings);
        }

        /// <summary>
        /// Returns true if UpdateWebhookSettings instances are equal
        /// </summary>
        /// <param name="other">Instance of UpdateWebhookSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateWebhookSettings other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
