...
namespace ReepayApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvoiceSearch :  IEquatable<InvoiceSearch>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceSearch" /> class.
        /// </summary>
        [JsonConstructor]
        ...
        /// <param name="Content">List of invoices for current page (required).</param>
        ...
        public InvoiceSearch(int? Page = null, int? Size = null, int? Count = null, string Search = null, string Sort = null, List<Invoice> Content = null, long? TotalElements = null, int? TotalPages = null)
        {
            // to ensure "Page" is required (not null)
            if (Page == null)
            {
                throw new InvalidDataException("Page is a required property for InvoiceSearch and cannot be null");
            }
            else
            {
                this.Page = Page;
            ...
            if (Size == null)
            {
                throw new InvalidDataException("Size is a required property for InvoiceSearch and cannot be null");
            }
            else
            {
                this.Size = Size;
            ...
            if (Count == null)
            {
                throw new InvalidDataException("Count is a required property for InvoiceSearch and cannot be null");
            }
            else
            {
                this.Count = Count;
            ...
            if (Content == null)
            {
                throw new InvalidDataException("Content is a required property for InvoiceSearch and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TotalElements is a required property for InvoiceSearch and cannot be null");
            }
            else
            {
            ...
            if (TotalPages == null)
            {
                throw new InvalidDataException("TotalPages is a required property for InvoiceSearch and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>List of invoices for current page</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as InvoiceSearch);
        }

        /// <summary>
        /// Returns true if InvoiceSearch instances are equal
        /// </summary>
        /// <param name="other">Instance of InvoiceSearch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceSearch other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
